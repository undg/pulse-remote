...
BUILD_PKG_PATH=github.com/undg/pulse-remote/api/buildinfo
...
rpm: build
	...
	sed "s/@VERSION@/$${PKG_VER}/" os/rpm/pulse-remote.spec > /tmp/pulse-rpm/rpmbuild/SPECS/pulse-remote.spec
	rpmbuild -bb --define "_topdir /tmp/pulse-rpm/rpmbuild" /tmp/pulse-rpm/rpmbuild/SPECS/pulse-remote.spec
